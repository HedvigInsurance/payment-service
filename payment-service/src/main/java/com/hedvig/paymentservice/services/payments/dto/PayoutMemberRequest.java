...
@Deprecated
public final class PayoutMemberRequest {
  ...
  private final String lastName;
    ...
    @java.beans.ConstructorProperties({"memberId", "amount", "address", "countryCode", "dateOfBirth", "firstName", "lastName"})
    public PayoutMemberRequest(String memberId, MonetaryAmount amount, String address, String countryCode, LocalDate dateOfBirth, String firstName, String lastName) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof PayoutMemberRequest)) return false;
        final PayoutMemberRequest other = (PayoutMemberRequest) o;
    ...
    public String toString() {
        return "PayoutMemberRequest(memberId=" + this.getMemberId() + ", amount=" + this.getAmount() + ", address=" + this.getAddress() + ", countryCode=" + this.getCountryCode() + ", dateOfBirth=" + this.getDateOfBirth() + ", firstName=" + this.getFirstName() + ", lastName=" + this.getLastName() + ")";
    }
}
