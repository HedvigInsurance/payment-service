...
public class AdyenTransaction {
    ...
    @Nullable
    public String getRescueReference() {
        return rescueReference;
    }

    public void setRescueReference(@Nullable String rescueReference) {
        this.rescueReference = rescueReference;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getTransactionId(), that.getTransactionId()) &&
            ...
            Objects.equals(getRescueReference(), that.getRescueReference()) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getTransactionId(), getMemberId(), getRecurringDetailReference(), getAmount(), getCurrency(), getTransactionStatus(), getReason(), getRescueReference(), getCreatedAt(), getUpdatedAt());
    }
}
