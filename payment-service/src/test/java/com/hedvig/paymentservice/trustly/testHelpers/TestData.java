...
public class TestData {
    ...
    public static PaymentRequest makePaymentRequest() {
        final FastMoney amount = FastMoney.of(123, Monetary.getCurrency("SEK"));
    ...
    public static Notification makeTrustlyCreditNotificationRequest() {
        ...
        final CreditData data = new CreditData();
    ...
    public static Notification makeTrustlyAccountNotificationRequest() {
        ...
        final AccountNotificationData data = new AccountNotificationData();
        ...
        final NotificationParameters parameters = new NotificationParameters();
