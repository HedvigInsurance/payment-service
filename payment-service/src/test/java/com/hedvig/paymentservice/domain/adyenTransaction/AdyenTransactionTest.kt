...
class AdyenTransactionTest {
  ...
  @Test
  fun given_noPriorActivity_when_InitiateAdyenTransactionCommand_and_AdyenResponseIsRefused_expect_AdyenTransactionInitiatedEvent_And_AdyenTransactionAuthorisedEvent() {
    val response = PaymentsResponse()
