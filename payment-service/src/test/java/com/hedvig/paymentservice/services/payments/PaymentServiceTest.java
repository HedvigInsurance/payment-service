...
public class PaymentServiceTest {
    ...
    private static final String TRUSTLY_CUSTOMER_INBOX_PATTERN = "trustly-customer-inbox\\+(\\d+)@hedvig.com";
    @Mock
    ...
    @Captor
    private ArgumentCaptor<CreateChargeCommand> captor;

    @Test
    public void givenChargeMemberRequest_whenChargeMember_thenSendCreateChargeCommand_WithTrustlyInboxEmail()   {
